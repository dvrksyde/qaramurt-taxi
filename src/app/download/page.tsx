...
const APK_URL = process.env.APK_DOWNLOAD_URL || "https://drive.google.com/file/d/1BH7BLneX5z2VnMAltNOThjgwVq1bpdpd/view?usp=sharing";
const APP_VERSION = process.env.APK_VERSION || "1.3.1";
