...
const APK_URL = process.env.APK_DOWNLOAD_URL || "https://drive.google.com/file/d/1x-pinY9PxdjDspomaffBuc9JA6vVCQ5G/view?usp=sharing";
const APP_VERSION = process.env.APK_VERSION || "1.7.7";
