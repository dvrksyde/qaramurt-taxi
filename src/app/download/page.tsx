...
const APK_URL = process.env.APK_DOWNLOAD_URL || "https://drive.google.com/file/d/1Us5GNKwNZQYpslmQ8tOFvXaJ26R0cx3P/view?usp=sharing";
const APP_VERSION = process.env.APK_VERSION || "1.1.1";
